...
def get_base_dataloader(args, clip_trsf=None):
    ...
    if args.dataset == 'classroom':
        ...
        trainset = args.Dataset.ClassRoom(train=True,classroom_type = 'vit_a2',session = 0)
        testset = args.Dataset.ClassRoom(train=False,classroom_type = 'vit_a2',session = 0)
...
def get_new_dataloader(args,session, clip_trsf=None):
    ...
    if args.dataset == 'classroom':
        ...
        trainset = args.Dataset.ClassRoom(train=True,classroom_type = 'vit_a2',session = session)
