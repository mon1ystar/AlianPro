...
from models.adapater.ViT_prompt_deep_orc import ViT_DEEP_ORC_A
...
class ViT_FSCILTrainer(Trainer):
    def __init__(self, args):
        ...
        trainable_encoder_params = sum(param.numel() for param in self.model.module.encoder.parameters() if param.requires_grad)
        self.init_params = sum(param.numel() for param in self.model.parameters())
        print('total parameters:',self.init_params)
        print('trainable encoder parameters:',trainable_encoder_params)
